      ...
      <section>
        <nav>
          <div className="logo-lockup">
            <img
              className="logo"
              src="https://image.flaticon.com/icons/svg/126/126508.svg"
              alt="logo"
            ></img>
            <h1>TUNE-IN LATER</h1>
          </div>
        ...
        <article className="main-container">
          <article className="search-form">
            <div className="search-form-container">
              <NavLink exact to="/search" className="a-search">
                Search Tunes
              </NavLink>
            ...
            {user && (
              <NavLink className="logout-link" exact to="/" onClick={logout}>
                LOGOUT
              </NavLink>
            )}
          </article>
          <section className="login-form-container">
            ...
            <div className="favorites-container">
              ...
              />
              <Route exact path="/search" component={CardContainer} />
              <Route
                exact
                path="/:id"
                render={({ match }) => {
